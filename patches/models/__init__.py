...
User.add_to_class(
            ...
            models.CharField(
                        max_length=2,
                        default=twmodeconst.DEFAULT_USER_STATUS,
                        choices=twmodeconst.USER_STATUS_CHOICES
                    )
        )
...
User.add_to_class('NewestQ', models.ForeignKey(Thread, related_name='the_newest_post'))
