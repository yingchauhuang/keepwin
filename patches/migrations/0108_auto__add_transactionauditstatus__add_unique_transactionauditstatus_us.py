...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TransactionAuditStatus'
        db.create_table(u'askbot_transactionauditstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('transaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Transaction'])),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal('askbot', ['TransactionAuditStatus'])

        # Adding unique constraint on 'TransactionAuditStatus', fields ['user', 'transaction']
        db.create_unique(u'askbot_transactionauditstatus', ['user_id', 'transaction_id'])

        # Adding model 'Transaction'
        db.create_table(u'transaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('income', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ...
            ('trans_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal('askbot', ['Transaction'])

        # Adding field 'Post.is_private'
        db.add_column('askbot_post', 'is_private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Post.is_charged'
        db.add_column('askbot_post', 'is_charged', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Post.cost'
        db.add_column('askbot_post', 'cost', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'TransactionAuditStatus', fields ['user', 'transaction']
        db.delete_unique(u'askbot_transactionauditstatus', ['user_id', 'transaction_id'])

        # Deleting model 'TransactionAuditStatus'
        db.delete_table(u'askbot_transactionauditstatus')

        # Deleting model 'Transaction'
        db.delete_table(u'transaction')

        # Deleting field 'Post.is_private'
        db.delete_column('askbot_post', 'is_private')

        # Deleting field 'Post.is_charged'
        db.delete_column('askbot_post', 'is_charged')

        # Deleting field 'Post.cost'
        db.delete_column('askbot_post', 'cost')
    ...
    models = {
        ...
        'askbot.transactionauditstatus': {
            'Meta': {'unique_together': "(('user', 'transaction'),)", 'object_name': 'TransactionAuditStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['askbot.Transaction']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'askbot.vote': {
