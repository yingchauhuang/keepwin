...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.future_pic'
        db.delete_column('askbot_post', 'future_pic')

        # Adding field 'Post.featurepic'
        db.add_column('askbot_post', 'featurepic', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Post.future_pic'
        db.add_column('askbot_post', 'future_pic', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Deleting field 'Post.featurepic'
        db.delete_column('askbot_post', 'featurepic')
