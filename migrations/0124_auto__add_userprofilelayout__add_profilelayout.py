...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserProfileLayout'
        db.create_table(u'userprofilelayout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('profilelayout', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.ProfileLayout'])),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('askbot', ['UserProfileLayout'])

        # Adding model 'ProfileLayout'
        db.create_table(u'profilelayout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('layout_type', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('html', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('askbot', ['ProfileLayout'])


    def backwards(self, orm):
        
        # Deleting model 'UserProfileLayout'
        db.delete_table(u'userprofilelayout')

        # Deleting model 'ProfileLayout'
        db.delete_table(u'profilelayout')
