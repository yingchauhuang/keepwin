...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.mobile_verified'
        db.add_column(u'userinfo', 'mobile_verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.mobile_verified'
        db.delete_column(u'userinfo', 'mobile_verified')
