...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfileLayout.content'
        db.alter_column(u'userprofilelayout', 'content', self.gf('django.db.models.fields.TextField')(null=True))

        # Adding field 'ProfileLayout.comment'
        db.add_column(u'profilelayout', 'comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'UserProfileLayout.content'
        db.alter_column(u'userprofilelayout', 'content', self.gf('django.db.models.fields.TextField')(default=''))

        # Deleting field 'ProfileLayout.comment'
        db.delete_column(u'profilelayout', 'comment')
