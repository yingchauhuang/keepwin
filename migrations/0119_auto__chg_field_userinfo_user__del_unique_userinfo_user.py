...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'userinfo', ['user_id'])

        # Changing field 'UserInfo.user'
        db.alter_column(u'userinfo', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'UserInfo.user'
        db.alter_column(u'userinfo', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))

        # Adding unique constraint on 'UserInfo', fields ['user']
        db.create_unique(u'userinfo', ['user_id'])
    ...
    models = {
        ...
        'askbot.userinfo': {
            ...
            'education': ('django.db.models.fields.CharField', [], {'default': "'h'", 'max_length': '2'}),
            'gender': ('django.db.models.fields.CharField', [], {'default': "'f'", 'max_length': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income': ('django.db.models.fields.CharField', [], {'default': "'3'", 'max_length': '2'}),
        ...
        'auth.user': {
            ...
            'NewestQ': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'the_newest_post'", 'to': "orm['askbot.Thread']"}),
            'UserInfo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'UserInfo'", 'to': "orm['askbot.UserInfo']"}),
