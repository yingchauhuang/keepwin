...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('askbot_transactionauditstatus', ['user_id', 'transaction_id'])

        # Deleting model 'TransactionAuditStatus'
        db.delete_table('askbot_transactionauditstatus')

        # Deleting field 'Transaction.is_auditted'
        db.delete_column(u'transaction', 'is_auditted')


    def backwards(self, orm):
        
        # Adding model 'TransactionAuditStatus'
        db.create_table('askbot_transactionauditstatus', (
        ...
        db.create_unique('askbot_transactionauditstatus', ['user_id', 'transaction_id'])

        # Adding field 'Transaction.is_auditted'
        db.add_column(u'transaction', 'is_auditted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
