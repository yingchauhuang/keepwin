...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.subtitle'
        db.add_column('askbot_thread', 'subtitle', self.gf('django.db.models.fields.CharField')(default='', max_length=300), keep_default=False)

        # Adding field 'Thread.passcode'
        db.add_column('askbot_thread', 'passcode', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.subtitle'
        db.delete_column('askbot_thread', 'subtitle')

        # Deleting field 'Thread.passcode'
        db.delete_column('askbot_thread', 'passcode')
