...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tagrelation', (
            ...
            ('Ind1', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('Ind2', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('Percent', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('askbot', ['TagRelation'])


    def backwards(self, orm):
        
        # Deleting model 'TagRelation'
        db.delete_table(u'tagrelation')
    ...
    models = {
        ...
        'askbot.tagrelation': {
            'Ind1': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
            'Ind2': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
            'Meta': {'ordering': "('symbol', 'name')", 'object_name': 'TagRelation', 'db_table': "u'tagrelation'"},
            'Percent': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
