...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.outcome'
        db.alter_column(u'transaction', 'outcome', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Transaction.income'
        db.alter_column(u'transaction', 'income', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Transaction.balance'
        db.alter_column(u'transaction', 'balance', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Transaction.outcome'
        db.alter_column(u'transaction', 'outcome', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Transaction.income'
        db.alter_column(u'transaction', 'income', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Transaction.balance'
        db.alter_column(u'transaction', 'balance', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'askbot.thread': {
            ...
            'passcode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10'}),
            'subtitle': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300'}),
            'tagnames': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
