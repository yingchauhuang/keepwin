...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'transaction', 'amount')


    def backwards(self, orm):
        
        # Adding field 'Transaction.amount'
        db.add_column(u'transaction', 'amount', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)
