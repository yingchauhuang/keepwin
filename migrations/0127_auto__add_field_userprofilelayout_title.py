...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfileLayout.title'
        db.add_column(u'userprofilelayout', 'title', self.gf('django.db.models.fields.CharField')(max_length=40, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfileLayout.title'
        db.delete_column(u'userprofilelayout', 'title')
