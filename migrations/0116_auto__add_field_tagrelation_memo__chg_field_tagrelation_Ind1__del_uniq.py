...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'TagRelation', fields ['symbol']
        db.delete_unique(u'tagrelation', ['symbol'])

        # Removing unique constraint on 'TagRelation', fields ['Ind2']
        db.delete_unique(u'tagrelation', ['Ind2'])

        # Removing unique constraint on 'TagRelation', fields ['name']
        db.delete_unique(u'tagrelation', ['name'])

        # Removing unique constraint on 'TagRelation', fields ['Ind1']
        db.delete_unique(u'tagrelation', ['Ind1'])

        # Adding field 'TagRelation.memo'
        db.add_column(u'tagrelation', 'memo', self.gf('django.db.models.fields.CharField')(max_length=60, null=True), keep_default=False)

        # Changing field 'TagRelation.Ind1'
        db.alter_column(u'tagrelation', 'Ind1', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'TagRelation.name'
        db.alter_column(u'tagrelation', 'name', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'TagRelation.Ind2'
        db.alter_column(u'tagrelation', 'Ind2', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'TagRelation.symbol'
        db.alter_column(u'tagrelation', 'symbol', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        
        # Deleting field 'TagRelation.memo'
        db.delete_column(u'tagrelation', 'memo')

        # User chose to not deal with backwards NULL issues for 'TagRelation.Ind1'
        raise RuntimeError("Cannot reverse this migration. 'TagRelation.Ind1' and its values cannot be restored.")

        # Adding unique constraint on 'TagRelation', fields ['Ind1']
        db.create_unique(u'tagrelation', ['Ind1'])

        # User chose to not deal with backwards NULL issues for 'TagRelation.name'
        raise RuntimeError("Cannot reverse this migration. 'TagRelation.name' and its values cannot be restored.")

        # Adding unique constraint on 'TagRelation', fields ['name']
        db.create_unique(u'tagrelation', ['name'])

        # User chose to not deal with backwards NULL issues for 'TagRelation.Ind2'
        raise RuntimeError("Cannot reverse this migration. 'TagRelation.Ind2' and its values cannot be restored.")

        # Adding unique constraint on 'TagRelation', fields ['Ind2']
        db.create_unique(u'tagrelation', ['Ind2'])

        # User chose to not deal with backwards NULL issues for 'TagRelation.symbol'
        raise RuntimeError("Cannot reverse this migration. 'TagRelation.symbol' and its values cannot be restored.")

        # Adding unique constraint on 'TagRelation', fields ['symbol']
        db.create_unique(u'tagrelation', ['symbol'])
    ...
    models = {
        ...
        'askbot.transaction': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
