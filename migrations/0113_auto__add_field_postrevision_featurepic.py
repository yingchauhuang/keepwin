...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostRevision.featurepic'
        db.add_column('askbot_postrevision', 'featurepic', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostRevision.featurepic'
        db.delete_column('askbot_postrevision', 'featurepic')
