...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagRelation.commonname'
        db.add_column(u'tagrelation', 'commonname', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TagRelation.commonname'
        db.delete_column(u'tagrelation', 'commonname')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'NewestQ': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'the_newest_post'", 'to': "orm['askbot.Thread']"}),
