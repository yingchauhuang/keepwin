...
settings.register(
    livesettings.StringValue(
        USER_SETTINGS,
        'NAME_OF_ADMINISTRATOR_USER',
        default = 'admin',
        description = _('Name for the forum user. This use will collect the income from the transactions')
    )
)
...
settings.register(
    livesettings.IntegerValue(
        ...
        'PERCENT_FOR_AUTHOR',
        default=30,
        description=_('The percent for sharing with Author')
    )
)
...
settings.register(
    livesettings.IntegerValue(
        ...
        'PERCENT_FOR_FORUM',
        default=70,
        description=_('The percent for sharing with Forum')
    )
)