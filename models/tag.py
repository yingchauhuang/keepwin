...
class TagRelationManager(BaseQuerySetManager):
    """
    """
    def create(self,symbol,name,Ind1,Ind2,Percent,memo):
        NewTR=TagRelation(symbol=symbol,
                    name=name,
                    Ind1=Ind1,
                    Ind2=Ind2,
                    Percent=Percent,
...
class TagRelation(models.Model):
    ...
    Ind1    = models.CharField(max_length=10, null=True)
    Ind2    = models.CharField(max_length=10, null=True)
    memo    = models.CharField(max_length=60, null=True)
    commonname    = models.BooleanField(default=False)
    Percent = models.FloatField(default=0)
    objects = TagRelationManager()

    class Meta:
        app_label = 'askbot'
        db_table = u'tagrelation'
