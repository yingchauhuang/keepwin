...
class UserInfo(models.Model):
    """
    The info we collet from user
    """
    user = models.OneToOneField(User)
    gender=models.CharField(max_length=2,
                            default=twmodeconst.DEFAULT_GENDER_STATUS,
                            choices=twmodeconst.USER_GENDER_CHOICES,
                            verbose_name=_('Gender'))
    education=models.CharField(max_length=2,
                            default=twmodeconst.DEFAULT_EDUCATION_STATUS,
                            choices=twmodeconst.USER_EDUCATION_CHOICES,
                            verbose_name=_('Eeducation'))
    income=models.CharField(max_length=2,
                            default=twmodeconst.DEFAULT_INCOME_STATUS,
                            choices=twmodeconst.USER_INCOME_CHOICES,
                            verbose_name=_('AnnualIncome'))
    occupational=models.CharField(max_length=2,
                            default=twmodeconst.DEFAULT_OCCUPATIONAL_STATUS,
                            choices=twmodeconst.USER_OCCUPATIONAL_CHOICES,
                            verbose_name=_('Occupational'))
    template=models.CharField(max_length=2,
    ...
    mobile_verified=models.BooleanField(default=False,verbose_name=_('Mobile_verified'))
    address=models.CharField(max_length=30,verbose_name=_('Address'))
    SAT1 =models.BooleanField(default=False,verbose_name=_('SAT1'))
    SAT2 =models.BooleanField(default=False,verbose_name=_('SAT2'))
    SAT3 =models.BooleanField(default=False,verbose_name=_('SAT3'))
    SAT4 =models.BooleanField(default=False,verbose_name=_('SAT4'))
    SAT5 =models.BooleanField(default=False,verbose_name=_('SAT5'))
    SAT6 =models.BooleanField(default=False,verbose_name=_('SAT6'))
    SAT7 =models.BooleanField(default=False,verbose_name=_('SAT7'))
    SAT8 =models.BooleanField(default=False,verbose_name=_('SAT8'))
    SAT9 =models.BooleanField(default=False,verbose_name=_('SAT9'))
    SAT10=models.BooleanField(default=False,verbose_name=_('SAT10'))
    SAT11=models.BooleanField(default=False,verbose_name=_('SAT11'))
    SAT12=models.BooleanField(default=False,verbose_name=_('SAT12'))
    SAT13=models.BooleanField(default=False,verbose_name=_('SAT13'))
    SAT14=models.BooleanField(default=False,verbose_name=_('SAT14'))
    SAT15=models.BooleanField(default=False,verbose_name=_('SAT15'))
    SAT16=models.BooleanField(default=False,verbose_name=_('SAT16'))
    SAT17=models.BooleanField(default=False,verbose_name=_('SAT17'))
    SAT18=models.BooleanField(default=False,verbose_name=_('SAT18'))
    SAT19=models.BooleanField(default=False,verbose_name=_('SAT19'))
    SAT20=models.BooleanField(default=False,verbose_name=_('SAT20'))
    SAT21=models.BooleanField(default=False,verbose_name=_('SAT21'))
    SAT22=models.BooleanField(default=False,verbose_name=_('SAT22'))
    SAT23=models.BooleanField(default=False,verbose_name=_('SAT23'))
    SAT24=models.BooleanField(default=False,verbose_name=_('SAT24'))
    SAT25=models.BooleanField(default=False,verbose_name=_('SAT25'))
    SAT26=models.BooleanField(default=False,verbose_name=_('SAT26'))
    SAT27=models.BooleanField(default=False,verbose_name=_('SAT27'))
    SAT28=models.BooleanField(default=False,verbose_name=_('SAT28'))
    SAT29=models.BooleanField(default=False,verbose_name=_('SAT29'))
    SAT30=models.BooleanField(default=False,verbose_name=_('SAT30'))
    SAT31=models.BooleanField(default=False,verbose_name=_('SAT31'))
    SAT32=models.BooleanField(default=False,verbose_name=_('SAT32'))
    SAT33=models.BooleanField(default=False,verbose_name=_('SAT33'))
    SAT34=models.BooleanField(default=False,verbose_name=_('SAT34'))
    SAT35=models.BooleanField(default=False,verbose_name=_('SAT35'))
    SAT36=models.BooleanField(default=False,verbose_name=_('SAT36'))
    SAT37=models.BooleanField(default=False,verbose_name=_('SAT37'))
    SAT38=models.BooleanField(default=False,verbose_name=_('SAT38'))
    SAT39=models.BooleanField(default=False,verbose_name=_('SAT39'))
    SAT40=models.BooleanField(default=False,verbose_name=_('SAT40'))
    SAT41=models.BooleanField(default=False,verbose_name=_('SAT41'))
    SAT42=models.BooleanField(default=False,verbose_name=_('SAT42'))
    SAT43=models.BooleanField(default=False,verbose_name=_('SAT43'))
