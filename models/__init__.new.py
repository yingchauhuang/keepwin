...
def user__question_post(self, refresh=False):
...
def user_user_summary_html(self):
        ...
        html = get_template('widgets/question_summary_vip.html').render(context)
...
User.add_to_class('_question_post', user__question_post)
