...
DATABASE_NAME = 'twmodeDB'             # Or path to database file if using sqlite3.
...
SERVER_EMAIL = 'yhuang@moneydj.com' 
DEFAULT_FROM_EMAIL = 'yhuang@moneydj.com' 
EMAIL_HOST_USER = 'yhuang' 
EMAIL_HOST_PASSWORD = 'perlin1997' 
EMAIL_SUBJECT_PREFIX = 'ASKBOT:' 
EMAIL_HOST='mail.moneydj.com' 
EMAIL_PORT='25' 
EMAIL_USE_TLS=False 
